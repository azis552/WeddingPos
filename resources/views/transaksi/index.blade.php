                    ...
                    @foreach ($transaksis as $transaksi)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-primary bayar"
                                    {{ $transaksi->statusTerakhir->status == 'batal' ? 'disabled' : '' }}
                                    data-bs-toggle="modal" data-bs-target="#Bayar" data-id="{{ $transaksi->id }}"
                                ...
                                <button class="btn btn-warning update_status"
                                    {{ $transaksi->statusTerakhir->status == 'batal' ? 'disabled' : '' }}
                                    data-bs-toggle="modal" data-bs-target="#updateStatus" data-id="{{ $transaksi->id }}">
                                    Update Status
                                </button>

                                <button class="btn btn-primary btnInvoice"
                                    {{ $transaksi->statusTerakhir->status == 'batal' ? 'disabled' : '' }}
                                ...
                                <tr>
                                    ...
                                    if (response.length == 1) {
                                        table += ` <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('transaksiSaya.bayar') }}" method="POST" enctype="multipart/form-data">
                                                                @csrf
